...
export class Backend implements backendInterface {
    ...
    async createTask(arg0: string, arg1: TaskType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createTask(arg0, to_candid_TaskType_n13(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_DecisionEntry_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DecisionEntry): Promise<DecisionEntry> {
    return await from_candid_record_n37(_uploadFile, _downloadFile, value);
}
function from_candid_DecisionType_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DecisionType): DecisionType {
...
function from_candid_ProfileRole_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProfileRole): ProfileRole {
    return from_candid_variant_n31(_uploadFile, _downloadFile, value);
}
function from_candid_RepeatInterval_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RepeatInterval): RepeatInterval {
    return from_candid_variant_n41(_uploadFile, _downloadFile, value);
}
async function from_candid_TaskCompletion_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TaskCompletion): Promise<TaskCompletion> {
...
async function from_candid_Task_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Task): Promise<Task> {
...
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_TaskCompletion]): Promise<TaskCompletion | null> {
    return value.length === 0 ? null : await from_candid_TaskCompletion_n21(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_opt_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_ExternalBlob>]): Promise<Array<ExternalBlob> | null> {
    return value.length === 0 ? null : await from_candid_vec_n43(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        currentCompletion: record_opt_to_undefined(await from_candid_opt_n20(_uploadFile, _downloadFile, value.currentCompletion))
    };
}
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        afterPhoto: record_opt_to_undefined(await from_candid_opt_n23(_uploadFile, _downloadFile, value.afterPhoto)),
        beforePhoto: record_opt_to_undefined(await from_candid_opt_n23(_uploadFile, _downloadFile, value.beforePhoto)),
...
async function from_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        role: from_candid_ProfileRole_n30(_uploadFile, _downloadFile, value.role),
...
async function from_candid_record_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        decision: from_candid_DecisionType_n38(_uploadFile, _downloadFile, value.decision),
        repeatInterval: from_candid_RepeatInterval_n40(_uploadFile, _downloadFile, value.repeatInterval),
        name: value.name,
        createdAt: value.createdAt,
        createdBy: value.createdBy,
        lastUpdated: value.lastUpdated,
        completionFiles: record_opt_to_undefined(await from_candid_opt_n42(_uploadFile, _downloadFile, value.completionFiles)),
        isDone: value.isDone,
        comment: record_opt_to_undefined(from_candid_opt_n25(_uploadFile, _downloadFile, value.comment)),
        completionComment: record_opt_to_undefined(from_candid_opt_n25(_uploadFile, _downloadFile, value.completionComment)),
        timestamp: value.timestamp,
        decisionFiles: record_opt_to_undefined(await from_candid_opt_n42(_uploadFile, _downloadFile, value.decisionFiles)),
        completionTimestamp: record_opt_to_undefined(from_candid_opt_n44(_uploadFile, _downloadFile, value.completionTimestamp))
    };
}
...
async function from_candid_tuple_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _UserProfile]): Promise<[Principal, UserProfile]> {
    return [
        value[0],
        await from_candid_UserProfile_n28(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Task>): Promise<Array<Task>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Task_n16(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _UserProfile]>): Promise<Array<[Principal, UserProfile]>> {
    return await Promise.all(value.map(async (x)=>await from_candid_tuple_n27(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DecisionEntry>): Promise<Array<DecisionEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DecisionEntry_n36(_uploadFile, _downloadFile, x)));
}
...
function to_candid_ProfileRole_n47(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProfileRole): _ProfileRole {
    return to_candid_variant_n48(_uploadFile, _downloadFile, value);
}
function to_candid_TaskType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TaskType): _TaskType {
...
async function to_candid_record_n46(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        role: to_candid_ProfileRole_n47(_uploadFile, _downloadFile, value.role),
        initials: value.initials,
        avatar: value.avatar
    };
}
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TaskType): {
    urgent: null;
} | {
    monthly: null;
} | {
...
function to_candid_variant_n48(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProfileRole): {
    manager: null;
} | {
    assistant: null;
} {
